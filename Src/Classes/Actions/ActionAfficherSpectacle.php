    ...
    public function execute() : string {
        ...
        if (isset($_REQUEST['id_spectacle'])) {
            ...
            if ($soirnee) {
                ...
                //afficher encore plus de détails pour un spectacle (8), (9), (10)
                //accès aux spectacles du même style (9)
                $html .= "<a><strong>Spectacle(s) dans le même style :</strong></a></br>";
                ...
                $html .= "</br><a><strong>Spectacle(s) à la même date :</strong></a></br>";
                ...
                $html .= "</br><a><strong>Spectacle(s) au même lieu :</strong></a><br>";
